...
class MatchFavoriteAdapter (private val context: Context?, private val favorite: MutableList<EventFavorite>):
        RecyclerView.Adapter<MatchFavoriteAdapter.FavoriteViewHolder>() {
    ...
    override fun onBindViewHolder(holder: FavoriteViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            context?.startActivity<DetailClub>(
                    DetailClub.ID_EVENTS to favorite[position].eventId,
                    DetailClub.ID_HOME to favorite[position].homeId,
                    DetailClub.ID_AWAY to favorite[position].awayId,
                    DetailClub.AWAY_NAME to favorite[position].awayName,
                    DetailClub.HOME_NAME to favorite[position].homeName)
        }
